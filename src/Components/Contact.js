...
const Contact = () => {
  return (
    <section id='contact' className=' w-full font-sans max-w-full '>
      <div class="relative isolate  text-white">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
          <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-32">
            <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
              ...
              <h2 class="text-3xl font-bold tracking-tight font-sans text-white">Contact Us</h2>
              <p class="mt-6 text-sm leading-8 font-sans text-white">Feel free to reach out to us for any inquiries or assistance.
              ...
              <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
                <div class="flex gap-x-4">
                  ...
                  <dd><a class="hover:text-gray-900 text-white font-sans" href="mailto:contact@yourcompany.com">contact@yourcompany.com</a></dd>
                </div>
                <div class="flex gap-x-4">
                  <dt class="flex-none">
                  ...
                  <dd className='text-white font-sans'>123 Main Street, Cityville, Country</dd>
                </div>
              </dl>
            </div>
          </div>
          <form class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-32">
            <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
              <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                <div>
                  <label for="first-name" class="block text-sm font-semibold leading-6 text-white font-sans">First name</label>
                  <div class="mt-2.5">
                ...
                <div>
                  <label for="last-name" class="block text-sm font-semibold leading-6 text-white font-sans">Last name</label>
                  <div class="mt-2.5">
                ...
                <div class="sm:col-span-2">
                  <label for="email" class="block text-sm font-semibold leading-6 text-white font-sans">Email</label>
                  <div class="mt-2.5">
                ...
                <div class="sm:col-span-2">
                  <label for="message" class="block text-sm font-semibold leading-6 text-white font-sans">Message</label>
                  <div class="mt-2.5">
              ...
              <div class="mt-8 flex justify-end">
                <button type="submit" class="w-max  rounded-2xl border-2 border-[#0057ff] bg-[#0057ff]  px-5 py-1.5 text-sm font-semibold text-white font-sans transition-colors duration-150 ease-in-out hover:border-blue-400 hover:bg-blue-400">Send message</button>
              </div>
            </div>
          </form>
        </div>
