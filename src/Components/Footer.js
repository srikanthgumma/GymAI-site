...
const Footer = ({ nav }) => {
  return (
    <section className=' text-white m-0 w-full max-w-full bg-blue-950'>
          ...
          <div className="container px-4 mx-auto">
            <div className="-mx-4 flex flex-wrap justify-between">
              <div className="px-4 my-4 w-full ">
                <a href="/" className="block w-56 mb-10 text-white text-5xl font-sans font-bold" >
                  GymAI
                </a>
                <p className="text-justify font-sans">
                  At GymAI.fit, we make group workouts fun, daily food healthy & tasty,
                  mental fitness easy with yoga & meditation, and medical & lifestyle care hassle-free. At GymAI.fit, we make group workouts fun, daily food healthy & tasty,
                  mental fitness easy with yoga & meditation, and medical & lifestyle care hassle-free. Donec porttitor, enim ut dapibus lobortis, lectus sem tincidunt dui, eget ornare lectus ex non libero. Nam rhoncus diam ultrices porttitor laoreet. Ut mollis fermentum ex, vel viverra lorem volutpat sodales. In ornare porttitor odio sit amet laoreet. Sed laoreet, nulla a posuere ultrices, purus nulla tristique turpis, hendrerit rutrum augue quam ut est. Fusce malesuada posuere libero, vitae dapibus eros facilisis euismod. Sed sed lobortis justo, ut tincidunt velit. Mauris in maximus eros. #BeBetterEveryDay
                </p>
              </div>
              ...
              <div className="px-4 my-4 w-full sm:w-auto">
                ...
                <ul className="leading-8">
                  <li><a href="#" className="hover:text-white font-sans ">Getting Started With Gym</a></li>
                  <li><a href="#" className="hover:text-white font-sans ">Gym Blogs</a></li>
                  <li><a href="#" className="hover:text-white font-sans">Gym blogs </a></li>
                  <li><a href="#" className="hover:text-white font-sans">5 Tips to stay strong</a></li>
